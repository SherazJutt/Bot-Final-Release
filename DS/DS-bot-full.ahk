...
script_start:
    ...
    ; close cheat engine
    Run, "close_CE.exe" %A_ScriptDir%

    ; starting
    ToolTip, Starting in 2 seconds , 640, 0,
...
main_menu_loaded_check_start:
    ...
    If (ErrorLevel = 0)
    {
        ...
        Send , {Escape}
        Sleep , 1000
        Run, "attach_script.exe" %A_ScriptDir%
        Sleep, 15000
        WinActivate, Asphalt 9: Legends
        WinMove , Asphalt 9: Legends, , 0, 0, 1280, 720
        WinRestore, Asphalt 9: Legends
...
main_menu_loaded_check_end:
    ...
    ; click on enter button to enter ds

    Text:="|<>*110$76."

    if (ok:=FindText(X:="wait", Y:=10, 1018, 494, 1105, 527, 0, 0, Text))
    {
        ToolTip, Entering in ds event , 640, 0,
        Click, 1113, 502 Left, 1
    }Else{
        ToolTip, ds event not found , 640, 0,
        Goto, script_start
    }

    WinActivate , Asphalt 9: Legends

    Text:="|<>*138$23.zkDzzkTzzkzy3VkA33UM670kAC1UMTv1kzrzVzjy3UMs70ksC1VkQ31ks63Vzw3Xzk"

    if (ok:=FindText(X:="wait", Y:=10, 1059, 192, 1089, 215, 0, 0, Text))
    {
        ; move button on cards for scrolling
        Click, 585, 395, 0
        Sleep, 1000
    ...
    ; click on card to show mission
    Click, 552, 447 Left, 1
    Sleep, 2500

reveal_next:

    Text:="|<>*117$44.yDkTUTUz3s3k3U7Uw0Q0s0sD76DCCAHllXlXX4wQMwMsXD76D6C8nllXlXUQwQMwMs0376D6C00llXnXXsQ8QMsEzD0D0C0Tnw7s7kC"

    if (ok:=FindText(X:="wait", Y:=10, 1010, 461, 1062, 486, 0, 0, Text))
    {
        ; click on mission card to reveal next button
        Sleep, 3000
        Click, 1140, 450 Left, 1
    }Else{
        ToolTip, mission card not found restarting from home , 640, 0,
        Goto, script_start
    }

    Text:="|<>*111$51.k67zb0tzz0kzwQ7Dzw6703VkD7Uks0CC0ky6701nU67kks07Q0kr6700z066Mkzs3s0kna7z0S066Aks03s0klq700z0667ks07Q0kky701nU663ks0CC0kkS703Vk661kzwQ70kk67zb0s64"
    if (ok:=FindText(X:="wait", Y:=10, 1027, 601, 1094, 630, 0, 0, Text))
    {
        ; click on next button to reveal play screen
        Sleep, 2000
        Click, 1137, 609 Left, 1
        ToolTip, play button found , 640, 0,
    }Else{
        Sleep, 1000
        ToolTip, next button not found , 640, 0,
        Goto, script_start
    }
...
play_start:
    Loop, 10{
        ...
        else
        {
            ...
            {
                ToolTip, play button not found , 640, 0,
                Goto, script_start
            }
        }
    }
...
play_end:
    ...
    Text:="|<>*154$34.0w0DzU7s1zz0TU7zy1y0S1wDw1s3ktk7UD3b0S0wSS1s3lts7UD73US0wQC1s3nkw7UDD1kS0ws71s3rzy7UDTzsS0xzzVs3r0C7UDw0wS0zk3lzzi077zws0QDzW"

    if (ok:=FindText(X:="wait", Y:=5, 932, 481, 976, 514, 0, 0, Text))
    {
        ...
        start:
            ...
            Loop, 60{
                ...
                Text:="|<>*126$42.0z003y03zs0DzU7zw0zzkDzy1zzsTVy1y7wT0z3w1yz0T3s0yy0T7s0yzzz7s0zzzz7s0zzzz7s0zy007s0zy007s0yz003s0yT0w3w1yTlz1y7wDzy1zzs7zw0zzk3zs0DzU0zU03y0U"

                if (ok:=FindText(X, Y, 700, 293, 751, 323, 0, 0, Text))
                {
                    Click, 827, 436 Left, 1
                }
                ...
                Text:="|<>*144$37.zzX0zwTzlUzzDzskTzkC0MS0s70AD0Q3U670C1k03U00s01s00Q00y00C00Dy07003zk3U00Ty1k000T0s0003UQ0001sC00Q0w700C0S3U07UC1k01sT0s00zzUQ00DzY"

                if (ok:=FindText(X, Y, 845, 477, 891, 511, 0, 0, Text))
                {
                    Send , {Escape}
                    Sleep, 2000
                    Goto, play_start
                ...
                ; if no more ads
                Text:="|<>*39$34.wTU7k7Uy0C0C3swsws7XnbnUSDCDwNswsDlbXnkD6SDDk8EswzsU3Xnrm06DCT9wMsss7lU3U0za0TUM"

                if (ok:=FindText(X, Y, 958, 467, 1001, 488, 0, 0, Text))
                {
                    Loop, 8{
                        Send , {Escape}
                        Sleep, 1000
                ...
                Text:="|<>*112$35.zzzzzlzzzzz3zzzzy7zzzzwDzzzzsTzzzzkzzzzzVzzzzz3U0Ts2400z00801w000z3sD03y7kzU7wDVz0DsT7y0TkyDw0zVwTs1z3szk3y7lzU7wDXz0DsT7y0TkyDw0zVwDs1z3sTk0s7kS100Dk0200TU070kzk68"

                if (ok:=FindText(X, Y, 414, 233, 480, 289, 0, 0, Text))
                {
                    Goto, script_start
                }
            }
    ...
    hunt_Space_loop_in_race_start:
        ...
        } Else
        {
            ...
            hunt_barrel_ramp_nitro_end:
                ...
                Text:="|<>*106$33.00T00M03s0100T000zzszk7zz7z0zzszs7zz7z0zzszs7zz7z0Tzszs00z7z007szs00z7z0Tzszs7zz7z0zzszs7zz7z0zzszs7zz7z0zzszk3zz3w003s0100T00A"

                if (ok:=FindText(X, Y, 1046, 107, 1090, 150, 0, 0, Text))
                {
                    Send, {Escape}
                }
                ; token icon check to verify home screen

                Text:="|<>*67$28.zzbzzzw7zzzUDzzs0Dzz00Tzk00zy000zk1U1w0D01U0y0006s080Pk0U37020AS0Q1zw1kDzk70zzUS60C3sM0wDU001z0007w000Tk001zU00Dy000zs003s"

                if (ok:=FindText(X, Y, 543, 42, 583, 82, 0, 0, Text))
                {
                    ; Goto , main_menu_loaded_check_start
                    Loop, 8{
                        Send, {Escape}
                ...
                if (ok:=FindText(X, Y, 787, 42, 823, 80, 0, 0, Text))
                {
                    ...
                    ToolTip, token color check to verify home screen to break loop, 640, 0,
                    Goto, script_start
                }

                ; hack your hazard level popup
                Text:="|<>*154$67.w07zwzzX0zwS03zyTztkzzD01zyDzskTzrU0w00C0MS0vk0S0070AD0Rs0D003U670Cw07U01k03U0S03k00s01s0D01s00Q00y07U0zy0C00Dy3k0Tz07003zts0DzU3U00Tyw07U01k000zS03k00s0003j01s00Q0001zU0w00C00Q0zk0S00700D0Ts0D003U07UCzz7U01k01wTTzXzy0s00zzjzlzz0Q00DzXzsTz06000w2"

                if (ok:=FindText(X, Y, 817, 480, 891, 512, 0, 0, Text))
                {
                    Loop, 8{
                        Send, {Escape}
                        Sleep, 1000
                    ...
                    ToolTip, shack your hazard level popup, 640, 0,
                    ; Goto , main_menu_loaded_check_start
                    ; MsgBox, error found
                    Goto, script_start
            ...
            hunt_Space_loop_in_race_end:
                ...
                Loop, 100{
                    ...
                    if (ok:=FindText(X, Y, 1010, 461, 1062, 486, 0, 0, Text))
                    {
                        ToolTip, race ended , 640, 0,
                        Goto, reveal_next
                    }Else{
                        Click, 1172, 636 Left, 1
                        Sleep, 1000
                    }
                }
                Text:="|<>*117$44.yDkTUTUz3s3k3U7Uw0Q0s0sD76DCCAHllXlXX4wQMwMsXD76D6C8nllXlXUQwQMwMs0376D6C00llXnXXsQ8QMsEzD0D0C0Tnw7s7kC"
                ...
                if (ok:=FindText(X:="wait", Y:=10,, 1010, 461, 1062, 486, 0, 0, Text))
                {
                    ToolTip, restarting race , 640, 0,
                    Goto, reveal_next

                }Else{
                    Click, 1226, 59 Left, 1
                    Sleep, 5000
                    Loop, 5
                    {
                        Click, 274, 645 Left,
